...
{block name='content'}
    ...
    <div class="container card p-2">
        ...
        <div class="d-flex">
            ...
            <input class="w-100 p-1" type="email" name="email" id="opc-email" placeholder="{l s='Email' d='Shop.Forms.Labels'}" required>
        </div>
        <div class="d-flex pt-1">
            ...
            <input class="w-100 p-1" type="number" name="zip" id="opc-zip" placeholder="{l s='Zip/Postal Code' d='Shop.Forms.Labels'}" required>
        </div>
        ...
        {if !$customer.is_logged or $customer.is_guest or !$customer.newsletter}
            ...
            {if !$customer.is_logged or $customer.is_guest}
                <div class="container-checkbox">
                    <input type="checkbox" id="createUser" name="createuser" value="true" onchange="togglePassword()" class="cb-createuser">
                    ...
                    <div id="pswd-container" style="display:none;" class="row py-1">
                        <div class="col-12">
                            ...
                            <br>
                            <label class="label-help">{l s='Your password must be at least 8 characters long.' mod='avardapayments'}</label>
                            <br>
